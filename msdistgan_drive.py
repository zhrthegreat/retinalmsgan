...
if __name__ == '__main__':
    ...
    ********************************************************************
    ...
    parser.add_argument('--db_name', type=str, default='drive', help='Database options: cifar10 or cifar100')
    parser.add_argument('--nnet_type', type=str, default='dcgan',
                        help='Network architectures: dcgan, sngan and resnet')
    ...
    parser.add_argument('--data_source', type=str, default='./data/drive/a/',
                        help='The dataset path to store (if data is unavailable, it is downloaded automatically)')
    parser.add_argument('--ss_task', type=int, default=2,
                        help='0: no SS, 1: SS task, 2: MS task (self-supervised task)')
