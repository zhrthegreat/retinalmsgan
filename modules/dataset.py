...
from modules.drive   import drive_preprocess
...
class Dataset(object):
    ...
    def __init__(self, name='mnist', source='./data/mnist/', batch_size = 64, seed = 0):
        ...
        if self.name == 'mnist':
            ...
            self.data_vec_dim = 786432 #512x512x3
            self.data_origin_shape = [512, 512, 3]
        else:
    ...
    def next_batch(self):
        ...
        #     return batch.T
            ...
            return batch
        elif self.name in ['celeba', 'stl10','drive']:
